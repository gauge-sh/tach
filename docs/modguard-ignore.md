...
Note: Dependency violations are detected at the import layer. This means that nonstandard ways to access modules/submodules such as `getattr`, `importlib`, or dynamically generated namespaces will not be caught by `modguard`.