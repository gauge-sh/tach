...
In case you would like to explicitly allow a certain external module, this can be configured in your [`tach.yml`](configuration#external-checks)
...
repos:
  - repo: https://github.com/gauge-sh/tach-pre-commit
    rev: v0.9.3 # change this to the latest tag!
    hooks:
      - id: tach
```
